...
export const Search = () => {
    ...
    return (
        <form className='flex w-full items-center max-w-lg' onSubmit={onSubmit}>
            <Input placeholder='Search' value={value} disabled className='rounded-r-none focus-visible:ring-offset-0' onChange={(event) => {setValue(event.target.value)}}/>
            <Button className='rounded-l-none' disabled type='submit'>
